...
6. ~~Cambiare il font~~ — risolto di riflesso da **M17** (Sora al posto di Space Grotesk, in tutta l'interfaccia).
7. ~~Cambiare logo e nome del prodotto~~ — promosso a milestone **M17** (nome "Ondo", nuovo logo, colore d'accento allineato).
