...
| M34 ✅ | **Foto profilo del creator più grande** (ex punto 11). Bump avatar: card 22→28px, sidebar 32→38px, dettaglio 38→48px, pagina creator 84→108px (font proporzionati; fallback iniziale-lettera invariato). | Build web pulita; solo CSS. |
