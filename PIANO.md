...
2. **Foto/avatar reali per i canali** (invece dell'iniziale generica mostrata oggi in sidebar/card/dettaglio) — da recuperare da YouTube (già presente `channel.url`/`uploaderUrl` nello schema, manca l'URL della foto profilo) e cachare localmente come le thumbnail dei video.
