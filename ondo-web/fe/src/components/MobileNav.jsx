...
import { Home, Download, Plus, Archive, Search } from 'lucide-react';
...
export function MobileNav() {
  ...
  return (
    <nav className="mobile-nav">
      ...
      <NavLink to="/downloads" className={cls}><Download size={17} />Download</NavLink>
      <NavLink to="/downloads" className="plus"><Plus size={20} /></NavLink>
