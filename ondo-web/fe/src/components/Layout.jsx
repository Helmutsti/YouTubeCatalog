...
import { Home, Download, Search, Archive, Settings, X } from 'lucide-react';
    ...
    <div className="shell">
      ...
      <div className="body-area">
        <nav className="sidebar">
          ...
          <NavLink to="/downloads" className={navCls}><Download size={16} />Download</NavLink>
          <NavLink to="/archived" className={navCls}><Archive size={16} />Archiviati</NavLink>
          <NavLink to="/settings" className={navCls}><Settings size={16} />Impostazioni</NavLink>
