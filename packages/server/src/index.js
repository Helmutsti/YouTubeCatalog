...
// Lock sulla libreria (M80). Questo sì blocca l'avvio, al contrario del
// preflight: senza yt-dlp si può ancora sfogliare, ma con una CLI già aperta
// sulla stessa libreria i due processi si sovrascriverebbero il catalogo a
// vicenda — e il danno lo si scopre quando è già fatto.
try {
